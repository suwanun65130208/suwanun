            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="about_main">
                     <div class="about_taital">About Me</div>
                     <p class="about_text">Name : Suwanun Chhaumket</p>
                     <br></br>
                     <p class="about_text">ID : 65130208</p>
                     <div class="about_bt"><a href="#">Nook</a></div>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="about_img"><img src="images/suwanun.jpg" width="384" height="512" alt=""></div>
               </div>
            </div>
         </div>
      </div>
